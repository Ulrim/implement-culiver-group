...
var THEMES = {
  ...
  amp: { color: '#14606E', chipbg: 'rgba(27,110,125,.1)',
    overlay: 'linear-gradient(150deg,rgba(27,110,125,.3),rgba(12,58,71,.55))',
    cover: 'linear-gradient(150deg,rgba(27,110,125,.5),rgba(12,58,71,.7))',
